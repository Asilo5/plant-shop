...
describe('Favourties Container', () => {

    describe('Favourties', () => {
        let mockfavPlants = [1, 2, 3];
        let mockAllPlants = [
            {
      ...
      it('should match snapshot', () => {
          let wrapper = shallow(<FavouritesContainer favouritePlants={mockfavPlants} 
                                                     allPlants={mockAllPlants} />);
    ...
    describe('mapStateToProps', () => {
        ...
        it('should return all state with their properties', () => {
            const mockState = {
                favouritePlants : ["5e16b29d88553086edcddc53"],
                allPlants : [
                    {
                          "__v": 0,
                          "_id": "5e16b29d88553086edcddc53",
